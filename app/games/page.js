...
const games = [
  {
    title: "Create Quiz",
    description: "Test your knowledge by creating custom quizzes on various subjects.",
  ...
  {
    title: "Create MCQs",
    description: "Enhance your learning by creating and solving multiple-choice questions.",
...
const EducationalGames = () => {
  return (
    <section className="w-screen min-h-screen bg-blue-100">
      <Navbar />
