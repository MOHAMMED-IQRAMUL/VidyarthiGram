  ...
  return (
    <main>
      ...
      <section className="w-full font-mono min-h-[700px] flex flex-col justify-center items-center bg-orange-100 gap-20">
        ...
        <div>
        <h1 className="font-extrabold text-4xl text-orange-400 ">
        ...
        <div>
          <div className="p-2 bg-orange-800 text-white border rounded-full px-5">Comming Sooon..</div>
        </div>
      </section>
      ...
      <section class="bg-white ">
        <div class="max-w-screen-xl px-4 py-12 mx-auto space-y-8 overflow-hidden sm:px-6 lg:px-8">
          ...
          <p class="mt-8 text-base leading-6 text-center text-gray-400">
            © 2024 IQRAMUL, All rights reserved.
          </p>
        </div>
      </section>
    </main>
